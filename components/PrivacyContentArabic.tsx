...
export default function PrivacyContentArabicNew() {
  return (
    <ThemedView style={[styles.container]}>
      <ThemedText style={[styles.title]}>سياسة خصوصية Open Mushaf</ThemedText>
      ...
      <ThemedText style={[styles.subtitle]}>لماذا لا نجمع البيانات؟</ThemedText>
      <ThemedText style={[styles.content]}>
      ...
      <ThemedText style={[styles.subtitle]}>نحن نحترم خصوصية أطفالك</ThemedText>
      <ThemedText style={[styles.content]}>
      ...
      <ThemedText style={[styles.subtitle]}>الحفاظ على أمان بياناتك</ThemedText>
      <ThemedText style={[styles.content]}>
      ...
      <ThemedText style={[styles.subtitle]}>تحديثات هذه السياسة</ThemedText>
      <ThemedText style={[styles.content]}>
      ...
      <ThemedText style={[styles.subtitle]}>اتصل بنا</ThemedText>
      <ThemedText style={[styles.content]}>
      ...
      >
        <ThemedText style={[styles.link]}>سياسة الخصوصية (الرابط)</ThemedText>
      </ExternalLink>
    </ThemedView>
  );
}
