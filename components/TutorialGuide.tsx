  ...
  return (
    <GestureDetector gesture={gestureHandler}>
      <Animated.View
        entering={
          isRTL
            ? FadeInLeft.duration(SLIDE_TRANSITION_DURATION)
            : FadeInRight.duration(SLIDE_TRANSITION_DURATION)
        }
        exiting={
          isRTL
            ? FadeOutRight.duration(SLIDE_TRANSITION_DURATION)
            : FadeOutLeft.duration(SLIDE_TRANSITION_DURATION)
        }
