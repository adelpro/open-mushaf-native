export const SLIDES = [
  ...
  },
  {
    ...
    description: [
      {
        text: 'يمكنك إظهار القائمة العلوية بالضغط على صفحة المصحف، تحتوي القائمة على خيارات:',
        align: 'center',
      },
      {
        text: '✓ ملئ الشاشة: تقوم بإضهار وإخفاء القائمة السفلية.',
        align: 'start',
      },
      {
        text: '✓ خاصية التنقل: تسمح لك بالتنقل في المصحف بكل سلاسة سواء بالصفحات أو الآيات.',
        align: 'start',
      },
      {
        text: '✓ خاصية البحث: تتيح لك البحث في نص القرآن الكريم.',
        align: 'start',
      },
    ],
