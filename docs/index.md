...
- [الورد اليومي](./tracker.md) - كيفية تتبع تقدمك في قراءة القرآن الكريم
  - [إحصائيات القراءة](./tracker.md#إحصائيات-القراءة) - عرض الرسوم البيانية والإحصائيات التفصيلية لتقدمك
- [التذكيرات](./reminders.md) - كيفية إعداد تذكيرات لقراءة القرآن الكريم
