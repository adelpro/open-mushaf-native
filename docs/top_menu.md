...
- **اسم السورة ورقمها**: يظهر اسم السورة مع رقمها داخل العلامة الإسلامية.
- **رقم الجزء واسمه**: يعرض رقم الجزء الحالي مع تسميته الترتيبية (مثل الجزء الأول).

### مؤشر تقدم الورد اليومي

يظهر في القائمة العلوية مؤشر تقدم دائري واحد (التقدم) يعرض نسبة إنجازك للورد اليومي:

- يتم تحديث المؤشر تلقائيًا كلما تقدمت في القراءة.
- يمكنك النقر على المؤشر للانتقال إلى صفحة تتبع الورد اليومي.
- عند إكمال الورد اليومي، سيظهر المؤشر مع علامة صح.

## أيقونات القائمة العلوية

تظهر الأيقونات مع تسميات مختصرة (تكبير، بحث، انتقال، التقدم):

### أيقونة التقدم

تنقلك إلى شاشة تتبع الورد اليومي وتُظهر نسبة الإنجاز في مؤشر دائري واحد.
...
تقوم أيقونة التكبير بإظهار أو إخفاء القائمة السفلية لعرض الصفحة بشكل كامل:

- انقر على أيقونة التكبير لتفعيل وضع ملء الشاشة.
